    ...
    <div>
      ...
      <header className="sticky top-0 z-50 border-b border-white/5 bg-zinc-950/95 backdrop-blur-md">
        <div className="mx-auto flex h-16 max-w-5xl items-center justify-between gap-4 px-4">
          ...
          <nav className="hidden items-center gap-6 text-sm md:flex" aria-label="Navegación principal">
            {([['#inicio', 'Inicio'], ['#servicios', 'Servicios'], ['#galeria', 'Galería'], ['#ubicacion', 'Ubicación']] as [string, string][]).map(([href, label]) => (
              <a
                key={href}
                href={href}
            ...
            <a
              href="#fidelizacion"
              className="relative flex flex-col items-center text-zinc-400 transition-colors hover:text-white after:absolute after:bottom-[-3px] after:left-0 after:h-[2px] after:w-0 after:rounded-full after:bg-amber-400 after:transition-all after:duration-300 hover:after:w-full"
            >
              <span className="mb-0.5 rounded bg-amber-400 px-1 py-px text-[8px] font-black uppercase tracking-wider text-zinc-900 leading-tight">New</span>
              Promos
            </a>
          </nav>
      ...
      <section id="inicio" className="relative flex min-h-[100dvh] flex-col items-center justify-center overflow-hidden bg-zinc-950 px-6 text-center">
        ...
        <div className="mt-10 flex flex-col items-center gap-3 sm:flex-row">
          ...
          <a
            href="#servicios"
            className="inline-flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-4 py-2 text-xs text-zinc-400 transition-colors hover:border-amber-400/30 hover:text-amber-400"
          >
            Ver servicios
          </a>
        </div>
